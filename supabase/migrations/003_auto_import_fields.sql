...
ADD COLUMN IF NOT EXISTS bible_version text DEFAULT 'NIV';
...
COMMENT ON COLUMN memory_items.bible_version IS 'Bible version used for this verse (NIV, KJV, ESV, etc)';
